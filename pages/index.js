...
export default function Home() {
  ...
  function ProcessPhoneNumber() {
    ...
    return (
      <form onSubmit={registerUser}>
        ...
        <input id="name"   defaultValue={defaultPhone} type="phone" style={{marginLeft:'2vw'}} autoComplete="name" required/>
        <button  className = "btn" type="submit" style={{marginLeft:'610px',marginTop:'3vh',
  ...
  function OtpValidate() {
    ...
    return (
      <form onSubmit={validateOtp}>
        ...
        <input id="otp" defaultValue={defaultOtp} style={{marginLeft:'2vw'}} type={otpValidation?"number":"password"}  autoComplete="name" required maxLength = "4" onInput={maxLengthCheck}/><br/><br/></>}
        {otpValidation?"":<>
          <button type="submit" style={{marginLeft:'8vw',marginTop:'3vh',
                                        backgroundColor:'#0070f3',
                                        color:'white',
                                        border:"none",
                                        padding:'4%',
  ...
  function LoginSuccess() {
    return (
      ...
      {/* {hideOtp?"":<>
        <label htmlFor="name">Enter OTP</label>
        <input type="number" style={{marginLeft:'2vw'}} autoComplete="name" required value="1111"/> 
      </>} */}
